...
class Frame{
	...
	float nRad;
	float[]n;
	float noiseStep=0.4f;
	float noiseTimestep=0.05f;
	...
	public void updateFrame(){
		...
		for(int j=0;j<howMany/360;j++){
			for(int i=0;i<360;i++){
				...
				float nTempX=(0.5f-noise(nArray[c],nTime));
				float nTempY=(0.5f-noise(nArray[c],nTime));
