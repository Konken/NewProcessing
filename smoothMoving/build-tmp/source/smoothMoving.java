...
public void setup() {
	...
	c[3]=new Circle(width/2,height/2,380);
	c[4]=new Circle(width/2,height/2,360);
...
public float get2(float t) {
	float value=(t==1.0f)?1.0f:-pow(2, -10 * t) + 1;
	return value;
}
  public void settings() { 	fullScreen(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "smoothMoving" };
    if (passedArgs != null) {
